...
class FirebaseAuthClient{
    ...
    fun login(emailId: String, password: String): FirebaseSignInResponse? {
        val requestBody: FirebaseSignInRequest = FirebaseSignInRequest(emailId, password, true)
    ...
    fun exchangeRefreshToken(refreshToken: String): RefreshTokenResponse? {
        val requestBody: RefreshTokenRequest = RefreshTokenRequest(refreshTokenGrantType, refreshToken)
