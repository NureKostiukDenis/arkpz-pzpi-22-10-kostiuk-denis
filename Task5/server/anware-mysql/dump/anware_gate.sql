...
CREATE TABLE `gate` (
  ...
  PRIMARY KEY (`id`),
  KEY `gate_warehouse` (`warehouse_id`),
  CONSTRAINT `gate_warehouse` FOREIGN KEY (`warehouse_id`) REFERENCES `warehouse` (`id`) ON DELETE CASCADE
...
INSERT INTO `gate` VALUES (1,'GATE001',2),(2,'GATE002',2),(3,'GATE003',2),(4,'XD-4445',1);
