...
import org.anware.data.service.WarehouseApiKeyService.WarehouseApiKeySignature
import org.anware.data.service.WarehouseApiKeyService.Type
import org.junit.jupiter.api.Assertions.*
import org.junit.jupiter.api.BeforeEach
import org.junit.jupiter.api.Test
import java.util.*

class WarehouseApiKeyServiceTest {

    private lateinit var apiKeyGenerator: WarehouseApiKeyService
    private var standartSecret = "mySuperSecretKey"
    private val signatureWithPassword = WarehouseApiKeySignature(
        warehouseId = "12345",
        warehouseName = "MainWarehouse",
        warehousePassword = "warehouseSpecificSecret",
        type = Type.READ
    )
    private val signatureWithoutPassword = WarehouseApiKeySignature(
        warehouseId = "12345",
        warehouseName = "MainWarehouse",
    ...
    @BeforeEach
    fun setup() {
        apiKeyGenerator = WarehouseApiKeyService()
